...
import { useDeleteDish, useGetAllDishes } from "@/queries/useDishes";
...
export default function DishTable() {
  ...
  const { data: dataDishAlls, refetch } = useGetAllDishes();
  const dataDishAll = dataDishAlls?.payload.data ?? [];
  let data: any[] = [];
  data = dataDishAll;
  console.log(dataDishAll);
    ...
    >
      <div className="w-full">
        ...
        <AlertDialogDeleteDish
          ...
          onClick={() =>
            deleteDishMutation.mutateAsync(dishDelete?.id as number, {
              onSuccess: () => {
                refetch();
              },
              onError: (error) => {
